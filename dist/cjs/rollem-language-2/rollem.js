...
function peg$parse(input, options) {
    ...
    const peg$c9 = function (l, r_list) {
        ...
        for (let i = 0; i < r_list.length; i++) {
            ...
            switch (op) {
                case '+':
                    result = (0, evaluators_1.add)(result, r);
                    break;
                case '-':
                    result = (0, evaluators_1.subtract)(result, r);
                    break;
                default:
    ...
    const peg$c15 = function (l, r_list) {
        ...
        for (let i = 0; i < r_list.length; i++) {
            ...
            switch (op) {
                case '*':
                    result = (0, evaluators_1.multiply)(result, r);
                    break;
                case '/':
                    result = (0, evaluators_1.divide)(result, r);
                    break;
                default:
    ...
    const peg$c18 = function (e) {
        return (0, evaluators_1.unaryMinus)(e);
    };
